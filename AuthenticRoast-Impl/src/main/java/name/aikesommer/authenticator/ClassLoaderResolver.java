...
/**
 * This is an internal interface used to find classes specified as init-params. It is used
 * by the implementations for specific containers.
 *
 * @author Aike J Sommer
 */
public interface ClassLoaderResolver {

    ClassLoader resolve(ServletContext context);
